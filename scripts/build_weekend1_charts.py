...
def load_chartc():
 p=Path(__file__).with_name('psxfunkin_chartc_v2.py'); spec=importlib.util.spec_from_file_location('chartc',p); m=importlib.util.module_from_spec(spec); sys.modules[spec.name]=m; spec.loader.exec_module(m); return m
