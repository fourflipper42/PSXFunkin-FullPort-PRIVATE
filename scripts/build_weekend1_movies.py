...
def main():
 ...
 for srcname,outname in MOVIES:
  ...
  run([a.psxavenc,'-q','-t','strcd','-v','v2','-f','37800','-b','4','-c','2','-s','320x240','-r','15','-x','2',src,out])
  ...
  r.append({'source':srcname,'file':outname,'frames':n,'duration':d,'bytes':out.stat().st_size})
